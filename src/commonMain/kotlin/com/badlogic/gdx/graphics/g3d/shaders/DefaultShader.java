...
public class DefaultShader extends BaseShader {
    ...
    protected void bindLights(final Renderable renderable, final Attributes attributes) {
        ...
        if (lights != null && lights.shadowMap != null) {
            set(u_shadowMapProjViewTrans, lights.shadowMap.projViewTrans);
            set(u_shadowTexture, lights.shadowMap.depthMap);
            set(u_shadowPCFOffset, 1.f / (2f * lights.shadowMap.depthMap.texture.getWidth()));
        }
