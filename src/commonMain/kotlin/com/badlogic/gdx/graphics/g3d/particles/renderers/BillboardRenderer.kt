 ...
 * @author Inferno
 */
class BillboardRenderer() : ParticleControllerRenderer<BillboardControllerRenderData?, BillboardParticleBatch?>(BillboardControllerRenderData()) {

    constructor(batch: BillboardParticleBatch?) : this() {
        setBatch(batch)
    }
    ...
    fun copy(): ParticleControllerComponent? {
        return BillboardRenderer(batch)
    }
