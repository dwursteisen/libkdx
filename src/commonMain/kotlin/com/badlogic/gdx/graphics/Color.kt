...
class Color {
    ...
    override fun toString(): String {
        var value: String = java.lang.Integer
    ...
    companion object {
        ...
        fun valueOf(hex: String): Color {
            ...
            val r: Int = java.lang.Integer.valueOf(hex.substring(0, 2), 16)
            val g: Int = java.lang.Integer.valueOf(hex.substring(2, 4), 16)
            val b: Int = java.lang.Integer.valueOf(hex.substring(4, 6), 16)
            val a = if (hex.length != 8) 255 else java.lang.Integer.valueOf(hex.substring(6, 8), 16)
        ...
        fun abgr8888ToColor(color: Color, value: Float) {
            val c: Int = NumberUtils.floatToIntColor(value)
