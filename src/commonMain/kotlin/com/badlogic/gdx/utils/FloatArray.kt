...
class FloatArray {
     ...
     */
    fun removeAll(array: FloatArray): Boolean {
        var size = size
        val startSize = size
        val items = items
        var i = 0
    ...
    override fun hashCode(): Int {
        ...
        val n = size
        while (i < n) {
            h = h * 31 + java.lang.Float.floatToIntBits(items[i])
            i++
        }
        return h
    }
    ...
    override fun equals(`object`: Any?): Boolean {
        ...
        if (`object` !is FloatArray) return false
        val array = `object`
    ...
    fun equals(`object`: Any, epsilon: Float): Boolean {
        ...
        val items1 = items
        val items2 = array.items
        for (i in 0 until n) if (java.lang.Math.abs(items1[i] - items2[i]) > epsilon) return false
        return true
    }
    ...
    companion object {
         ...
         * @see .FloatArray
         */
        fun with(vararg array: Float): FloatArray {
