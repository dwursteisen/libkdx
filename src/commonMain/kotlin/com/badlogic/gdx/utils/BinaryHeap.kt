 ...
 * @author Nathan Sweet
 */
class BinaryHeap<T : Node?> @JvmOverloads constructor(capacity: Int = 16, private val isMaxHeap: Boolean = false) {
    ...
    fun add(node: T): T {
        ...
        if (size == nodes.size) {
            ...
            java.lang.System.arraycopy(nodes, 0, newNodes, 0, size)
            nodes = newNodes
        }
