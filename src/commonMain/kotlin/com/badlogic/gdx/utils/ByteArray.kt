...
class ByteArray {
     ...
     * memory copy.
     */
    constructor(ordered: Boolean, array: ByteArray?, startIndex: Int, count: Int) : this(ordered, count) {
        size = count
     ...
     */
    fun removeAll(array: ByteArray): Boolean {
        var size = size
        val startSize = size
        val items = items
        var i = 0
    ...
    override fun equals(`object`: Any?): Boolean {
        ...
        if (`object` !is ByteArray) return false
        val array = `object`
    ...
    companion object {
         ...
         * @see .ByteArray
         */
        fun with(vararg array: Byte): ByteArray {
