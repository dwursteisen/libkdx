...
class IntArray {
    ...
    constructor(ordered: Boolean = true, capacity: Int = 16) {
        ...
        items = kotlin.IntArray(capacity)
    }
     ...
     */
    constructor(array: kotlin.IntArray) : this(true, array, 0, array.size) {}
     ...
     * memory copy.
     */
    constructor(ordered: Boolean, array: kotlin.IntArray?, startIndex: Int, count: Int) : this(ordered, count) {
        size = count
     ...
     */
    fun removeAll(array: IntArray): Boolean {
        var size = size
        val startSize = size
        val items = items
        var i = 0
     ...
     * @return [.items]
     */
    fun ensureCapacity(additionalCapacity: Int): kotlin.IntArray {
     ...
     * @return [.items]
     */
    fun setSize(newSize: Int): kotlin.IntArray {
    ...
    protected fun resize(newSize: Int): kotlin.IntArray {
        val newItems = kotlin.IntArray(newSize)
        val items = items
    ...
    fun toArray(): kotlin.IntArray {
        val array = kotlin.IntArray(size)
    ...
    override fun equals(`object`: Any?): Boolean {
        ...
        if (`object` !is IntArray) return false
        val array = `object`
    ...
    companion object {
         ...
         * @see .IntArray
         */
        fun with(vararg array: Int): IntArray {
