...
class ShortArray {
     ...
     */
    fun removeAll(array: ShortArray): Boolean {
        var size = size
        val startSize = size
        val items = items
        var i = 0
    ...
    override fun equals(`object`: Any?): Boolean {
        ...
        if (`object` !is ShortArray) return false
        val array = `object`
    ...
    companion object {
         ...
         * @see .ShortArray
         */
        fun with(vararg array: Short): ShortArray {
