 ...
 *
 *
 * Contains information about the HTTP status line returned with the [HttpResponse] after a [HttpRequest] was
...
class HttpStatus(
     ...
     * and server errors, respectively (see [HTTP/1.1: Status Code
 * Definitions](http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html) for more information about HTTP status codes).
     */
    var statusCode: Int) {
