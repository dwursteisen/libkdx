...
class Affine2 : Serializable {
    ...
    fun set(matrix: Matrix3): Affine2 {
        val other: FloatArray = matrix.`val`
    ...
    fun setToRotation(degrees: Float): Affine2 {
        val cos: Float = MathUtils.cosDeg(degrees)
        val sin: Float = MathUtils.sinDeg(degrees)
        m00 = cos
        m01 = -sin
        m02 = 0f
        m10 = sin
    ...
    fun setToRotationRad(radians: Float): Affine2 {
        val cos: Float = MathUtils.cos(radians)
        val sin: Float = MathUtils.sin(radians)
        m00 = cos
        m01 = -sin
        m02 = 0f
        m10 = sin
